...
def get_weather_forecast():
    ...
    try:
        ...
        for city in CITIES:
            url = f"http://api.weatherapi.com/v1/forecast.json?key={API_key}&q={city}&days=8&aqi=no&alerts=yes"
            ...
            for value in data['forecast']['forecastday']:
                forecast_date = value['date']
                fname = f"weather_forecast_{city}_{forecast_date}.json"
                current_data = json.dumps(value)
